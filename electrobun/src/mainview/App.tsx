...
import type { ServiceUsage, UsageWindow } from "../shared/rpc";
import { desktopRpc } from "./lib/electrobun-rpc";
			...
			<div class="card-credits rounded-xl p-6 animate-fade-in">
				...
				<Show when={u.source}>
					<div class="mt-4 pt-4 border-t border-cyan-400/10">
						<span class="text-[10px] text-zinc-600 font-mono truncate">
							{u.source}
						</span>
					</div>
				</Show>
...
export default function App() {
	...
	async function fetchUsage() {
		...
		setError(null);
		try {
			const data = await desktopRpc.getAllUsage();
			setUsage(data);
			...
			<div class="max-w-5xl mx-auto p-6 md:p-10 relative z-10">
				<header class="mb-10 animate-fade-in">
					<div class="flex items-center justify-between">
						<div>
							<p class="section-label text-zinc-600 mb-1">
								API Quota Dashboard
							</p>
					...
					<div class="space-y-10">
						...
						<section class="animate-fade-in animate-fade-in-delay-2">
							<div class="flex items-center gap-3 mb-4">
								...
								<h2 class="section-label text-zinc-500">
									Credits & Balance
								</h2>
								<div class="flex-1 h-px bg-gradient-to-r from-zinc-800 to-transparent" />
							</div>
